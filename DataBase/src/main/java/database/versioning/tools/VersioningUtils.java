...
public class VersioningUtils {
    ...
    /**
     * Метод, возвращающий {@link TokensWrapper},<br> хранящий "разницу" двух JSON
    ...
    /**
     * Метод, восстанавливающий предыдущее состояние объекта<br>
    ...
    /**
     * Метод, находящий "разницу" строк (относительно первой строки)<br> и токенизирующий ее
     * @see Token
    ...
    /**
     * Метод, восстанавливающий состояние строки по<br> строке её последней версии и токенам строки предыдущей версии
